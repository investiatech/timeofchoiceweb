        ...
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
            ...
            <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
                <div className="md:flex md:justify-between">
                    ...
                    <a href="https://investia.store/czaswyborow" className="flex items-center">
                        <Image className="mr-2"
                            ...
                            alt="Logo"
                        />
                        {/* <span className="hidden md:flex self-center text-3xl font-semibold whitespace-nowrap">Czas Wyborów</span> */}
                    </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Odnośniki</h2>
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link href="#" className="hover:underline">Start</Link>
                                </li>
                                <li className="mb-4">
                                    <Link href="#features" className="hover:underline">O naszej Grze</Link>
                                </li>
                                <li className="mb-4">
                                    <Link href="#price" className="hover:underline">Przedsprzedaż</Link>
                                </li>
                                <li className="mb-4">
                                    <Link href="#" className="hover:underline">FAQ</Link>
                                </li>
                                <li className="mb-4">
                                    <Link href="#" className="hover:underline">Opinie</Link>
                                </li>
                                <li className="mb-4">
                                    <Link href="#about" className="hover:underline">Forum</Link>
                                </li>
                                <li>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Informacje prawne</h2>
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="#" className="hover:underline">Polityka prywatności</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:underline">Warunki i zasadny</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Czas Wyborów</a>. All Rights Reserved.
                    </span>
